#!/bin/bash
# Run round-robin baseline evaluation on datasets with 10-20 items
...
echo -e "${BLUE}Starting round-robin baseline evaluation on datasets (10-20 items)...${NC}"
echo ""
...
for m in {10..20}; do
    ...
    echo -e "${GREEN}Evaluating (RR): $dataset${NC}"
