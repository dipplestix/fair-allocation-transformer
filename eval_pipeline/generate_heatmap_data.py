#!/usr/bin/env python3
"""
Generate datasets and evaluate residual model for heatmap visualization.
...
def evaluate_on_data(model, matrices, nash_welfare_max, util_welfare_max, batch_size=100):
...
def main():
    ...
    parser.add_argument('--output', type=str, default='results/heatmap_data.json')
    ...
    for n, m in tqdm(configs, desc="Evaluating configs"):
        ...
        # Evaluate
        util_pct, nash_pct = evaluate_on_data(model, matrices, nash_max, util_max)
